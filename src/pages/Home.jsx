    ...
    <div className='home'>
      ...
      <div className='home-pg1-container' style={backgroundStyle}>
        <div className='centered'>
          <div className='white-text abril-fatface-regular size-very-large welcome-to' >{database.homepage['welcome-screen']['text-1']}</div>
          <div className='white-text size-large roboto-regular welcome-to-heim-church'>{database.homepage['welcome-screen']['text-2']}</div>
          <div className='home-button-container'>
            <RegularButton color='white' bgcolor='blue' text={database.homepage['welcome-screen']['button-1']} width={150} height={50} to='Watchlive'/>
            <RegularButton color='white' bgcolor='blue' text={database.homepage['welcome-screen']['button-2']} width={150} height={50} to='Offering'/>
          </div>
        </div>
      </div>

      <div className='home-pg2-container'>
        <h1 className="roboto-bold size-medium">{database.homepage['pg2-coming-up-text']}</h1>
        <EventsContainer/>
        <RegularButton color='white' bgcolor='blue' text={database.homepage['calendar-button-text']} width={200} height={80} to='Calendar'/>
      </div>
      ...
      <div className='home-pg3-container'>
        <div className='home-pg3-container-1'>
          <AboutUs to='About'/>
          <LinkContainers 
            title={database.homepage['container-2-title']}
        ...
        <div className='home-pg3-container-1'>
          <Request title={database.homepage['container-3-title']} width='500px' height='275px' buttonText={database.homepage['container-3-button-text']} image={prayer_request} to='Prayer'/>
          <LinkContainers title={database.homepage['container-4-title']}
            icons={[]}
            links={database.homepage['container-4-links']}
            to={['Offering', 'Others']}
          />
        </div>
