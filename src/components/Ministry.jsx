  ...
  return (
    ...
    <div className='ministry--container maximum-height'>
      ...
      <div style={{marginTop: '35px'}} className='ministry--subcontainer-1'>
        {picture1 && <img className='rounded-border' width='50%' height='100%' src={picture1}></img>}
        <div>
      ...
      <div style={{marginTop: '35px'}} className='ministry--subcontainer-1'>
        ...
        {picture2 && <img className='rounded-border' width='60%' height='100%' src={picture2}></img>}
      </div>

      <div style={{marginTop: '35px'}} className='ministry--subcontainer-1'>
        {picture3 && <img className='rounded-border' width='60%' height='100%' src={picture3}></img>}
        <div>
      ...
      <div style={{marginTop: '50px', marginBottom: '20px'}} className='ministry--subcontainer-1 ministry-subcontainer-leaders'>
        {picture4 && <img className='rounded-border' width='35%' height='70%' src={picture4}></img>}
      </div>
      {questions}
    </div>
    <Footer/>
